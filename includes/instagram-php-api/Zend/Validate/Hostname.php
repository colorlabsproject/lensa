 ...
 */
require_once ( get_template_directory() . '/includes/instagram-php-api/Zend/Validate/Abstract.php' );

/**
 * @see Zend_Validate_Ip
 */
require_once ( get_template_directory() . '/includes/instagram-php-api/Zend/Validate/Ip.php' );
