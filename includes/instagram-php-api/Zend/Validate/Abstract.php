 ...
 */
require_once ( get_template_directory() . '/includes/instagram-php-api/Zend/Validate/Interface.php' );
...
abstract class Zend_Validate_Abstract implements Zend_Validate_Interface
{
    ...
    public static function getDefaultTranslator()
    {
        if (null === self::$_defaultTranslator) {
            require_once ( get_template_directory() . '/includes/instagram-php-api/Zend/Registry.php' );
