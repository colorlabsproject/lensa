 ...
 */
require_once ( get_template_directory() . '/includes/instagram-php-api/Zend/Validate/Hostname.php' );
...
class Zend_Uri_Http extends Zend_Uri
{
    ...
    protected function __construct($scheme, $schemeSpecific = '')
    {
        ...
        // Validate the URI
        if ($this->valid() === false) {
            require_once ( get_template_directory() . '/includes/instagram-php-api/Zend/Uri/Exception.php' );
