 ...
 * @see Zend_Uri_Http
 */
require_once ( get_template_directory() . '/includes/instagram-php-api/Zend/Uri/Http.php' );
 ...
 */
require_once ( get_template_directory() . '/includes/instagram-php-api/Zend/Http/Client/Adapter/Stream.php' );
