 ...
 * @see Zend_Loader
 */
require_once ( get_template_directory() . '/includes/instagram-php-api/Zend/Loader.php' );


/**
 * @see Zend_Uri
 */
require_once ( get_template_directory() . '/includes/instagram-php-api/Zend/Uri.php' );


/**
 * @see Zend_Http_Client_Adapter_Interface
 */
require_once ( get_template_directory() . '/includes/instagram-php-api/Zend/Http/Client/Adapter/Interface.php' );


/**
 * @see Zend_Http_Response
 */
require_once ( get_template_directory() . '/includes/instagram-php-api/Zend/Http/Response.php' );

/**
 * @see Zend_Http_Response_Stream
 */
require_once ( get_template_directory() . '/includes/instagram-php-api/Zend/Http/Response/Stream.php' );
...
class Zend_Http_Client
{
    ...
    public function setUri($uri)
    {
        ...
        if (!$uri instanceof Zend_Uri_Http) {
            ...
            require_once ( get_template_directory() . '/includes/instagram-php-api/Zend/Http/Client/Exception.php' );
